import require$$0, { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, defineAsyncComponent, Suspense, mergeProps, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks, createDebugger } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/hookable@6.1.1/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/@nuxt+nitro-server@4.4.8_@babel+plugin-syntax-typescript@7.29.7_@babel+core@7.29.7__db0_8da500afe074b2f04187c919061ce3d4/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { defu } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs";
import { debounce } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/perfect-debounce@2.1.0/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs";
import "/home/jrdnbrd/projets/nuxt/site-vitrine/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
...
const unhead_888I1AePu1DUrtPK81_rJr00j4vtR52ShGy5miU_F2k = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-BW1PO4zG.js")
  },
  {
    name: "creations",
    path: "/creations",
    component: () => import("./_nuxt/creations-DKBrLKTp.js")
  },
  {
    name: "l-atelier",
    path: "/l-atelier",
    component: () => import("./_nuxt/l-atelier-CWHU3JMg.js")
  },
  {
    name: "savoir-faire",
    path: "/savoir-faire",
    component: () => import("./_nuxt/savoir-faire-DIvftv-Q.js")
  },
  {
    name: "sur-mesure",
    path: "/sur-mesure",
    component: () => import("./_nuxt/sur-mesure-BloIw6cr.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-C_JmgTcY.js")
  }
];
var shared_cjs_prod = {};
...
const debug_hooks_YOfVbiLQ32PEQjWPwXIZdxarXIXXTWodS_haosYIzso = /* @__PURE__ */ defineNuxtPlugin({
...
const revive_payload_server_eKVgkU6osOHrGvMPf25PyfQsVxXodciA1_dlsQ3JawM = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead_888I1AePu1DUrtPK81_rJr00j4vtR52ShGy5miU_F2k,
  plugin$1,
  debug_hooks_YOfVbiLQ32PEQjWPwXIZdxarXIXXTWodS_haosYIzso,
  revive_payload_server_eKVgkU6osOHrGvMPf25PyfQsVxXodciA1_dlsQ3JawM,
  plugin,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8
];
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-D6nZRVv7.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DqxOco58.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CrCV65MW.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.8_@babel+plugin-syntax-jsx@7.29.7_@babel+core@7.29.7__@babel+plugin-syntax-typ_b25ab90dbe578afff0bc494a4f6d33e8/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.8_@babel+plugin-syntax-jsx@7.29.7_@babel+core@7.29.7__@babel+plugin-syntax-typ_b25ab90dbe578afff0bc494a4f6d33e8/node_modules/nuxt/dist/app/components/nuxt-root.vue");
